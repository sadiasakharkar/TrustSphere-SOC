...
def main() -> None:
    if len(sys.argv) < 4:
        print("Usage: python scripts/run_incident_correlation_demo.py <input_path> <dataset_id> <domain> [limit]")
        raise SystemExit(1)
    ...
    print(json.dumps({"incident_count": len(incidents), "incidents": incidents[:3]}, indent=2))
